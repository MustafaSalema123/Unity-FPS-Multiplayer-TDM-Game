...
using UnityEngine;
    ...
    public class ThirdPersonCharacter : MonoBehaviour
    {
        ...
        CameraControlledIK cameraControlledIK;
    ...
    private void Awake()
        {
            cameraControlledIK = FindObjectOfType<CameraControlledIK>();
        ...
        cameraControlledIK.SplineRotation();
            camController.CameraRotate();

        }
        public void Moves(Vector3 move, bool crouch ,  bool jump, bool slide)
        {
        ...
        public void updateLate(Vector3 move, bool crouch, bool prone, bool forwards, bool backwards, bool strafe, float horizontal, float vertical)
        {
            m_TurnAmount = camController.relativeYaw;
            transform.eulerAngles = new Vector3(0, camController.transform.eulerAngles.y, 0);
            UpdateAnimator(move, crouch, prone, forwards, backwards, strafe, horizontal, vertical);
        }
        ...
        public void UpdateAnimator(Vector3 move, bool crouch, bool prone, bool forwards, bool backwards, bool strafe, float horizontal, float vertical)
        {
