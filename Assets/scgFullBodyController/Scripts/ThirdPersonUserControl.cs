...
using UnityEngine;
    ...
    private void Awake()
        ...
        verticalInput = Input.GetAxis("Vertical");
            ...
            //    m_Jump = false;
            //}
            if (Input.GetKeyDown(KeyCode.C) /*inputManager.crouchInput */ )
            {
            ...
            if (/*Input.GetButtonDown("Crouch") */ inputManager.crouchInput && prone)
            {
            ...
            if (inputManager.proneInput && crouch)
            {
                crouchToggle = !crouchToggle;
                crouch = false;
                prone = true;
            ...
            if (/*Input.GetButton("Sprint") && Input.GetButtonDown("Crouch")*/ inputManager.bInput && inputManager.crouchInput && m_Character.m_IsGrounded)
            {
                slide = true;
                crouch = false;
            ...
            m_Character.updateLate(m_Move, crouch, prone, forwards, backwards, strafe, horizontalInput, verticalInput);
        }
        ...
        m_CamForward = Vector3.Scale(m_Cam.forward, new Vector3(1, 0, 1)).normalized;
            ...
            m_Character.Moves(m_Move, crouch, m_Jump, slide);
